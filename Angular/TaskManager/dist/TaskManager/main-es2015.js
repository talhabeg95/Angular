...
let ProjectsComponent = class ProjectsComponent {
    ...
    ngOnInit() {
        ...
        this.clientLocationsService.getClientLocation().subscribe((response) => {
...
let ClientLocationStatusValidatorDirective = ClientLocationStatusValidatorDirective_1 = class ClientLocationStatusValidatorDirective {
    constructor() { }
    validate(control) {
        let isValid = true;
...
let ClientLocationsService = class ClientLocationsService {
...
ClientLocationsService.ctorParameters = () => [
...
let JwtUnAuthorizedInterceptorService = class JwtUnAuthorizedInterceptorService {
    constructor() {
    }
    intercept(request, next) {
...
let ProjectIDUniqueValidatorDirective = ProjectIDUniqueValidatorDirective_1 = class ProjectIDUniqueValidatorDirective {
    constructor(projectsService) {
        this.projectsService = projectsService;
    }
    validate(control) {
        return this.projectsService.getProjectByProjectID(control.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((existingProject) => {
...
ProjectIDUniqueValidatorDirective.ctorParameters = () => [
...
let TeamSizeValidatorDirective = TeamSizeValidatorDirective_1 = class TeamSizeValidatorDirective {
    constructor() { }
    validate(control) {
